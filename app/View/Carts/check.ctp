...
<p>
    ...
    if ($duplicates == null && $mDuplicates == null && $mDuplicateMethod == null && $hDuplicates == null && $hooksDuplicateC == null && $fDuplicates == null && $filtersC ==null){
        ...
        echo 'The following fields have duplicates:'."<br>";
        if($duplicates !=null){
            echo "function names"."<br>";
        }
        if($fDuplicates != null){
            echo "tag_names"."<br>";
        }
        if($filtersC!= null){
            echo "filter callbacks"."<br>";
        }
        if($mDuplicates != null){
            echo "Class names"."<br>";
        }
        if($mDuplicateMethod != null){
            echo "Method Names"."<br>";
        }
        if($hDuplicates != null){
            echo "Hooks"."<br>";
        }
        if($hooksDuplicateC != null){
            echo "Hook callbacks"."<br>";
        }
        
    }    
    if ($duplicates == null && $mDuplicates != null){
        echo "There are no duplicate functions, so you would be safe from function collisions.";
    }
    ?>
    <br>
