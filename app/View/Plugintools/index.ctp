...
<table  class="table table-bordered">
    ...
    <tbody>
        <?php foreach ($plugintools as $plugintool): ?>
            <tr>            	
                <td> 
                    <?php echo h($plugintool['Plugintool']['id']);   ?> 	
                </td>
                <td>
                    <?php   echo $this->Html->link($plugintool['Plugintool']['name'], array('controller'=>'Plugintools','action'=>'view', $plugintool['Plugintool']['id'])); ?>
                </td>
                <td class="actions">
                    ...
                    <?php   echo $this->Html->link('Select', array('controller'=>'Plugintools','action'=>'run', $plugintool['Plugintool']['id']),array('class'=>'btn-info btn btn-sm')); ?>             
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
